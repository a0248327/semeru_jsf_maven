package main.java.br.com.semeru.validators;
...
public class PasswordValidator implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		/*
		 * Monta um array de caracteres com o conteúdo da senha e
		 * percorre-o contando quantos numeros a senha possui
		 */
		...
		/*
		 * Monta um array de caracteres com o conteúdo da senha e
		 * percorre-o contando quantos caracteres especias a senha
		 * possui
		 */
		for (int i = 0; i < password.length(); i++) {
		...
		if (password == null || password.equals("")) {
			...
			// Verifica se foi encontrado pelo menos um número e um
			// caracter especial
			...
			// Verifica se a senha possui pelo menos 7 caracteres e
			// no máximo 22
